...
struct Request {
    ...
    void connection_handler(boost::system::error_code ec, const Endpoint& endpoint) {
        ...
        boost::asio::async_write(socket, boost::asio::buffer(request), [this](boost::system::error_code ec, size_t transferred) {
    ...
    void write_handler(boost::system::error_code ec, size_t transferred) {
        if (ec) {
            ...
            boost::asio::async_read(socket, boost::asio::dynamic_buffer(response), [this](boost::system::error_code ec, size_t transferred) {
...
int main() {
    ...
    Request request{ io_context, "www.mbassale.cl" };
    io_context.run();
